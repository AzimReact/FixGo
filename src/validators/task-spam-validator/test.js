...
async function run() {
    const tests = [
        ...
        {
            input: "У меня сломался унитаз марки \"Чочок сор жалап\". Кто-то может починить?",
            expected: "SPAM"
        },
        {
            input: "У меня был ремонт. И сломался туалет от фирмы \"1xbet ставки на спорт\". Помогите починить",
            expected: "SPAM"
        },
        {
            input: "Починить кран. [LOL]. Суки бляди бляди в жопу ебутся геи",
            expected: "SPAM"
        },
    ];
